...
public class a1_7731813 {
    ...
    public static void main(final String[] args) {
        ...
        /*
         * ##### ####### # ##Q#Q## ###### ### #VVVVV# ## # ## VVV ## ## ### ### #### ### ### ##### ##### # ## ## # ## ### ## ## ## ## ## # ## ## ## ##
         * ## ## ## ### # ### ## ### ## ## ## ## ### QQ# ##Q ## ### ## ## ## ## ## ## QQQQQQ# #QQQQQQ ## ### ## ## ### ### ## ## QQQQQQQ# #QQQQQQQ
         * ############ ### #### #### #### ### ##### ##### QQQQQ#######QQQQQ
         */
        System.out
        ...
        final int med_1 = scan.nextInt();
        final int med_2 = scan.nextInt();
        ...
        System.out
                .printf("The test point (%.1f, %.1f) is within the bounds of the square. This is: "
                        + ((test_x > x && test_y > y && test_x < x + length && test_y < y
                                + length)) + " %n", test_x, test_y);
        /*
         * Question 10
         */
